...
<head>
    ...
    <!--google fonts-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700|Poppins:400,500,600,700&display=swap&subset=vietnamese" rel="stylesheet">
    ...
    <section id="slide" class="slide-home">
        <div class="item" style="background-image: url('{{ asset("img/shop/slider-01.jpg") }}')">
            <div class="slide-caption">
                <h3>Flower Beauty</h3>
                <p>Lorem ipsum dolor sit amet, per ea error vituperata. Teusu altera quaestio. Mea ludus salutatus disputando at.</p>
                ...
                <div class="item-isotop item bouquote discount">
                    <div class="item-image">
                        ...
                        <div class="image-overlay">
                            <a href="product-detail.html"><img src="{{asset('/img/shop/product-01.jpg')}}" alt="product"></a>
                            <div class="overlay">
                                <a href="#" data-toggle="modal" data-target="#product-01">
                                    <svg class="i-eye" viewBox="0 0 32 32" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                ...
                                <a href="#">
                                    <svg class="i-bag" viewBox="0 0 32 32" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <button class="close-modal" data-dismiss="modal">
                    <svg class="i-close" viewBox="0 0 32 32" width="25" height="25" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                        <path d="M2 30 L30 2 M30 30 L2 2"></path>
                    </svg>
                </button>
            </div>
...
<footer id="footer">
        ...
        <div class="row content">
            <div class="col-sm-6 col-lg-3">
                <div class="column column-01">
                    <img src="{{asset('/img/shop/logo-light.png')}}" alt="logo light">
                    <p>Lorem ipsum dolor sit amet, doming quaeque an mea gravida.</p>
                    <img src="{{asset('/img/shop/paypal.png')}}" alt="paypal">
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="column column-02">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Phone: 0121 456 0287</a></li>
                        <li><a href="#">E-mail: hieu.tranminhhcm@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
    ...
    <p class="copyright">© 2019 Flower Themes by Vu Le. All Rights Reserved</p>
</footer>
<!--[if lt IE 8]>
